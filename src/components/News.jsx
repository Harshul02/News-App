...
export class News extends Component {
  ...
  componentDidMount(){
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=${secret}&page=1&pageSize=${this.props.pageSize}`;
  ...
  handleNextClick = ()=> {
    ...
    {
      let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=${secret}&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`;
    // let data = await fetch(url);
    fetch(url)
    .then((res) => res.json())
    .then((json) => {
